...
const Hero = () => {
  const handleDownload = () => {
    ...
    link.href = BaseInfo.resume; // Replace with the actual file URL from BaseInfo
  ...
  return (
    <section id="home">
      <div className="w-full pt-[4vh] md:pt-[12vh] h-screen bg-[--dark-blue] overflow-hidden relative">
